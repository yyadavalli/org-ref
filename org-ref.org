...
If you do not get json data, org-ref-doi-utils will not be able to generate the bibtex entry.

Not all PDFs can be retrieved. org-ref-doi-utils uses a set of functions to attempt this. Here is the list.
